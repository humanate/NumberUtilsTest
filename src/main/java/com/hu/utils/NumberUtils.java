...
public class NumberUtils {
  ...
  /**
   * public static boolean isCreatable(String str) Checks whether the String a valid Java number.
   * <p>
   ...
   * <p>
   * Parameters: str - the String to check Returns: true if the string is a correctly formatted
   * number Since: 3.5
   */
  public static boolean isCreatable(final String str) {
    ...
    if (sz > start + 1 && chars[start] == '0' && !str
        .contains(".")) { // leading 0, skip if is a decimal number
